    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
               ...
               .requestMatchers("/employees/**","/orders/**").hasAnyRole(SADMIN.name(),ADMIN.name(),EMPLOYEE.name(), PROSPECT.name(),RECRUITER.name(),SALES.name(),HR_MANAGER.name(),"GROUP_ADMIN")
                ...
                .requestMatchers("/timesheets/reminders/**").hasAnyRole(SADMIN.name(),ADMIN.name(),HR_MANAGER.name(),GROUP_ADMIN.name())
                .requestMatchers(POST,"/paystubs/**").hasAnyRole(SADMIN.name(),ADMIN.name(),HR_MANAGER.name(),GROUP_ADMIN.name())
                .requestMatchers(DELETE,"/paystubs/**").hasAnyRole(SADMIN.name(),ADMIN.name(),HR_MANAGER.name(),GROUP_ADMIN.name())
                .requestMatchers(GET,"/paystubs/all").hasAnyRole(SADMIN.name(),ADMIN.name(),HR_MANAGER.name(),GROUP_ADMIN.name())
                .requestMatchers(GET,"/paystubs/**").hasAnyRole(SADMIN.name(),ADMIN.name(),HR_MANAGER.name(),GROUP_ADMIN.name(),EMPLOYEE.name())
                .requestMatchers("/paystubs/**").hasAnyRole(SADMIN.name(),ADMIN.name(),HR_MANAGER.name(),GROUP_ADMIN.name(),EMPLOYEE.name())
